document.addEventListener('DOMContentLoaded', function() {
    // Product data
    const products = [
        { id: 1, name: "Vanilla Dream", description: "Classic vanilla bean with Madagascar ", price: 4.99, image: "https://images.unsplash.com/photo-1563805042-7684c019e1cb?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" },
        ...
        { id: 6, name: "Rocky Road", description: "Chocolate ice cream with marshmallows and nuts", price: 2.99, image: "https://images.unsplash.com/photo-1516559828984-fb3b99548b21?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" },
    
        { id: 7, name: "Cookies & Cream", description: "Vanilla ice cream with Oreo cookie pieces", price: 5.29, image: "https://images.unsplash.com/photo-1497034825429-c343d7c6a68f?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" },
        { id: 8, name: "Rocky Road", description: "Chocolate ice cream with marshmallows and nuts", price: 3.49, image: "https://images.unsplash.com/photo-1516559828984-fb3b99548b21?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" }
];
    ...
    function addToCart(e) {
        ...
        const whatsappLink = `https://wa.me/${+212669973483}?text=${encodeURIComponent(message)}`;
